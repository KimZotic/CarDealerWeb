...
import { getAdminCarById } from "@/lib/cars";
      ...
      <section className="mx-auto w-full max-w-5xl px-3 py-4 sm:px-4 sm:py-5 lg:px-6 lg:py-7">
        <div className="space-y-5">
          ...
          <div className="rounded-[24px] border border-white/10 bg-white/[0.04] p-4 backdrop-blur-xl sm:p-5 lg:p-6">
            <h1 className="text-2xl font-semibold sm:text-3xl">Edit Car</h1>

            <div className="mt-6">
              <CarForm mode="edit" action={updateCarAction} initialData={car} />
            </div>
          </div>
        </div>
      </section>
